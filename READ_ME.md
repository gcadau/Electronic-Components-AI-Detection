...
usage: train.py [-h] [--data_path DATA_PATH] [--split SPLIT]
                [--transform TRANSFORM] [--normalize] [--mean MEAN [MEAN ...]]
                [--std STD [STD ...]] [--resize] [--height HEIGHT]
                [--width WIDTH] [--one_hot_encoding] [--name NAME]
                [--format FORMAT] [--buffer_size BUFFER_SIZE]
                [--batch_size BATCH_SIZE] [--model_path MODEL_PATH]
                [--domain_randomization] [--dom_rand__mode DOM_RAND__MODE]
